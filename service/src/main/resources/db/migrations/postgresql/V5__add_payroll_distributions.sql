...
CREATE TABLE maat_payroll_distributions ( id BIGSERIAL, customer_id BIGINT NOT NULL, main_account_number VARCHAR(34) NOT NULL, created_by VARCHAR(32) NOT NULL, created_on TIMESTAMP(3) NOT NULL, last_modified_by VARCHAR(32) NULL, last_modified_on TIMESTAMP(3) NULL,
...
CREATE TABLE maat_payroll_allocations ( id BIGSERIAL, payroll_distribution_id BIGINT NOT NULL, account_number VARCHAR(34) NOT NULL, amount NUMERIC(15,5) NOT NULL, proportional BOOLEAN NOT NULL,
